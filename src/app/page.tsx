    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-74px)] max-w-7xl gap-8 px-4 py-8 sm:px-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:py-12">
        <div className="max-w-2xl">
          <div className="mb-6 inline-flex border-2 border-black bg-yellow-400 px-3 py-2 text-xs font-black uppercase">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link
              href="/explore"
              className="border-2 border-black bg-black px-6 py-4 text-center text-sm font-black uppercase text-white transition hover:bg-yellow-400 hover:text-black"
            >
              Start Exploring
            </Link>
            <Link
              href="/login"
              className="border-2 border-black bg-white px-6 py-4 text-center text-sm font-black uppercase text-black transition hover:bg-neutral-100"
            >
              Login
            </Link>
          </div>
        ...
        <div className="grid grid-cols-5 gap-3 border-2 border-black bg-neutral-100 p-3">
      ...
      <section className="border-y-2 border-black bg-black px-4 py-10 text-white sm:px-6">
